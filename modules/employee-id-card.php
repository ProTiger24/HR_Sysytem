...
$stmt = $db->prepare("SELECT * FROM users WHERE id = ? AND user_type = 'employee'");
...
<div class="navbar no-print">
    ...
    <div>
        <a href="employees.php"><i class="fas fa-arrow-left me-2"></i>Back</a>
    </div>
</div>
        ...
        <div class="body">
            ...
            <div class="profile-section">
                <?php if(!empty($employee['profile_picture']) && file_exists('../' . $employee['profile_picture'])): ?>
                    <img src="../<?php echo $employee['profile_picture']; ?>" class="profile-img" alt="Profile">
                <?php else: ?>
